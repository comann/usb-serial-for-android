...
public class SerialInputOutputManager implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            EventBus.getDefault().post(new SerialErrorEvent(this, mDriver, e));
    ...
    private void step() throws IOException {
        ...
        if (len > 0) {
            ...
            //Dispatch the event to any one listening....
            EventBus.getDefault().post(new ReadDataEvent(this, data));
